...
const questions = [
  ...
  { text: "A social hierarchy is natural.", axis: "interference", direction: -1 },
  ...
  { text: "If the government must exist, it ought to be minimized to only bare functions such as emergency services, law & defense, or welfare.", axis: "interference", direction: 1 },
  { text: "The state ought to be a means to an end.", axis: "interference", direction: 1 },
  { text: "Acts and organizations, like jury duty or public schools, made compulsory by the state, are evil and should be abolished.", axis: "interference", direction: 1 },
  ...
  { text: "The concept of society and social norms should be abolished entirely.", axis: "interference", direction: 1 },
  ...
  { text: "If not my type of state, one should not exist.", axis: "interference", direction: 1 },
